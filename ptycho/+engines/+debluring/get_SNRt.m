% SNRt = get_SNRt_3D_2e(image,param)
% Computes the SNRt with Fourier shell correlation for a single image by splitting
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function SNRt = get_SNRt(image,param)
import math.isint
import utils.*
...
SNRt = sqrt(nansum(SSNR .* freq) / sum(freq));  % average SNR (should correspond to signal^2 / noise^2)
